...
add wave -noupdate -radix unsigned /processor_forwarding_stall/clk
add wave -noupdate -radix unsigned /processor_forwarding_stall/pc
add wave -noupdate -radix unsigned /processor_forwarding_stall/instruction
add wave -noupdate -radix unsigned /processor_forwarding_stall/alu_op
add wave -noupdate -radix unsigned /processor_forwarding_stall/mem_to_reg
add wave -noupdate -radix unsigned /processor_forwarding_stall/reg_wrt
add wave -noupdate -radix unsigned /processor_forwarding_stall/mem_wrt
add wave -noupdate -radix unsigned /processor_forwarding_stall/branch
add wave -noupdate -radix unsigned /processor_forwarding_stall/sign_extend
add wave -noupdate -radix unsigned /processor_forwarding_stall/use_imm
add wave -noupdate -radix unsigned /processor_forwarding_stall/use_sa
add wave -noupdate -radix unsigned /processor_forwarding_stall/rs
add wave -noupdate -radix unsigned /processor_forwarding_stall/rt
add wave -noupdate -radix unsigned /processor_forwarding_stall/rd
add wave -noupdate -radix unsigned /processor_forwarding_stall/immediate_extended
add wave -noupdate -radix unsigned /processor_forwarding_stall/shamt_extended
add wave -noupdate -radix unsigned /processor_forwarding_stall/alu_b_reg_imm
add wave -noupdate -radix unsigned /processor_forwarding_stall/alu_a
add wave -noupdate -radix unsigned /processor_forwarding_stall/alu_b
add wave -noupdate -radix unsigned /processor_forwarding_stall/alu_r
add wave -noupdate -radix unsigned /processor_forwarding_stall/of_flag
add wave -noupdate -radix unsigned /processor_forwarding_stall/z_flag
add wave -noupdate -radix unsigned /processor_forwarding_stall/reg_bus_a
add wave -noupdate -radix unsigned /processor_forwarding_stall/reg_bus_b
add wave -noupdate -radix unsigned /processor_forwarding_stall/reg_bus_wrt
...
add wave -noupdate -radix unsigned /processor_forwarding_stall/test_comp/code
add wave -noupdate -radix unsigned /processor_forwarding_stall/test_comp/init
add wave -noupdate -radix hexadecimal /processor_forwarding_stall/test_comp/pc_init_data
add wave -noupdate -color Orange -radix unsigned /processor_forwarding_stall/test_comp/clk
add wave -noupdate -radix unsigned /processor_forwarding_stall/test_comp/clk_inv
add wave -noupdate /processor_forwarding_stall/clk_cnt
add wave -noupdate -group {if stage} -radix hexadecimal /processor_forwarding_stall/test_comp/pc
add wave -noupdate -group {if stage} -radix hexadecimal /processor_forwarding_stall/test_comp/instruction
add wave -noupdate -group {if stage} -radix unsigned /processor_forwarding_stall/test_comp/take_branch
add wave -noupdate -group {if stage} -radix unsigned /processor_forwarding_stall/test_comp/stall
...
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/reg_bus_a_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/reg_bus_b_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/shamt_extended_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/alu_op_id_ex
add wave -noupdate -group id_ex_pipeline -radix hexadecimal /processor_forwarding_stall/test_comp/pc_id_ex
add wave -noupdate -group id_ex_pipeline -radix hexadecimal /processor_forwarding_stall/test_comp/instruction_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/mem_to_reg_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/reg_wrt_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/mem_wrt_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/branch_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/sign_extend_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/use_imm_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/use_sa_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/stall_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/immediate_extended_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/rs_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/rt_id_ex
add wave -noupdate -group id_ex_pipeline -radix unsigned /processor_forwarding_stall/test_comp/rd_id_ex
...
add wave -noupdate -group {ex stage} -radix unsigned /processor_forwarding_stall/test_comp/alu_b_reg_imm
add wave -noupdate -group {ex stage} -radix unsigned /processor_forwarding_stall/test_comp/alu_a
add wave -noupdate -group {ex stage} -radix unsigned /processor_forwarding_stall/test_comp/alu_b
add wave -noupdate -group {ex stage} -radix hexadecimal /processor_forwarding_stall/test_comp/alu_r
add wave -noupdate -group {ex stage} -radix unsigned /processor_forwarding_stall/test_comp/of_flag
add wave -noupdate -group {ex stage} -radix unsigned /processor_forwarding_stall/test_comp/z_flag
add wave -noupdate -group {ex stage} /processor_forwarding_stall/test_comp/stall_logic
add wave -noupdate -group {ex stage} -radix unsigned /processor_forwarding_stall/take_branch
...
add wave -noupdate -group stalling /processor_forwarding_stall/test_comp/stall_logic
...
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc_init
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc_init_data
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/clk
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/immediate_extended
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/take_branch
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/stall
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc_plus_4
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc_branch
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/immediate_extended_x4
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc_next
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc_next_val
add wave -noupdate -group pc_controller /processor_forwarding_stall/test_comp/pc_control/pc_curr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {38178 ps} 0}
