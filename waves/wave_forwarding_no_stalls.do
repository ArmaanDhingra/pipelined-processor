...
add wave -noupdate -expand -group {if stage} -radix hexadecimal /processor_forwarding_no_stalls/test_comp/pc
add wave -noupdate -expand -group {if stage} -radix hexadecimal /processor_forwarding_no_stalls/test_comp/instruction
add wave -noupdate -expand -group {if stage} -radix unsigned /processor_forwarding_no_stalls/test_comp/take_branch
add wave -noupdate -expand -group {if stage} -radix unsigned /processor_forwarding_no_stalls/test_comp/stall
...
add wave -noupdate -group forwarding -radix unsigned /processor_forwarding_no_stalls/test_comp/alu_a_mem_wb
add wave -noupdate -group forwarding -radix unsigned /processor_forwarding_no_stalls/test_comp/alu_a_valid
add wave -noupdate -group forwarding -radix unsigned /processor_forwarding_no_stalls/test_comp/alu_b_mem_wb
add wave -noupdate -group forwarding -radix unsigned /processor_forwarding_no_stalls/test_comp/alu_b_valid
add wave -noupdate -group forwarding /processor_forwarding_no_stalls/test_comp/forward_rs
add wave -noupdate -group forwarding /processor_forwarding_no_stalls/test_comp/forward_rt
